...
$result = mysqli_query("select banid,unix_timestamp(dtmtill) as till,address,comment from ${mysqlprefix}chatban", $link)
		or die(' Query failed: ' . mysqli_error($link));

$blockedList = array();
while ($ban = mysqli_fetch_array($result, mysqli_ASSOC)) {
	$blockedList[] = $ban;
}
